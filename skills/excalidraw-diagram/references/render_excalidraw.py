...
def render(
    ...
    # Serve references dir via local HTTP so ES module imports work
    port = _find_free_port()
    handler = partial(SimpleHTTPRequestHandler, directory=str(refs_dir))
    ...
    with sync_playwright() as p:
        ...
        page.goto(template_url, wait_until="networkidle", timeout=60000)
